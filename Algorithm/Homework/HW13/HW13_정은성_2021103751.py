...
class Heap(object):
    ...
    def __init__(self, data):
        ...
        self.move_count = 0  # 데이터 이동 횟수를 기록할 변수
    ...
    def siftUp(self, i):
        ...
        while i >= 2 and self.data[i] > self.data[i // 2]:
            ...
            i //= 2
            self.move_count += 1  # 데이터 이동 횟수 증가
...
print("Move Count for Heap 1:", b1.move_count)  # 데이터 이동 횟수 출력
...
print("Move Count for Heap 2:", b2.move_count)  # 데이터 이동 횟수 출력
# addElt
b2.addElt(50)
print("Heap 2 after adding 50:", b2.data[1:])
print("Move Count for Heap 2 after adding 50:", b2.move_count)  # 데이터 이동 횟수 출력